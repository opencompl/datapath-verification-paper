...
map word-level arithmetic to optimized compressor trees that avoid delay-inducing intermediate sums. The price of this optimization is a netlist
whose structure no longer resembles the arithmetic it implements.
...
Compressor trees can be used to implement arbitrary sums of products, e.g., $a*b+c*d+e$, and modern synthesis tools now automatically recognize and replace such sub-circuits during datapath synthesis. 
While efficient and widely used, compressor trees usually have highly irregular structures, increasing the difficulty of verifying the generated circuits~\cite{mul_verif}.
