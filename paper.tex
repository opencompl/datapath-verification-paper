...
As the core of our proof, we formalize the bit heap data structure~\cite{arithmetic_core_generation_bitheaps,application_specific_arithmetic}, 
...
\begin{table}
  ...
  \begin{tabular}{lrrrr}
    \toprule
    & \multicolumn{2}{c}{Ours\,/\,Basline} & \multicolumn{2}{c}{Verification Time (s)} \\
...
These files provide verification hints such as which multiplie architecture was used.
